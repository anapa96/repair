...
<head>
  ...
  <script src="https://api-maps.yandex.ru/2.1/?apikey=c72f28e5-8321-4199-9f42-afdbf15d0e3b&lang=ru_RU">
  </script>
</head>
<body>
  <nav class="navbar">
      ...
      <div class="navbar-block">
        ...
        <div class="navbar__info">
          <div class="navbar__contacts">
            ...
            <a href="tel:+74954225131" class="navbar__phone">+7 (495) 42-251-31</a>
          </div>
          <!-- /.navbar__contacts -->
        ...
        <div class="offer-block wow slideInLeft" data-wow-delay="0.4s">
          ...
          <div class="offer-feedback">
            ...
            <span class="offer-feedback__text wow fadeInRight" data-wow-delay="1.4s">или перезвоните нам сами <br>
              <a class="offer-feedback__number" href="tel:+74954225131" >+7 (495) 42-251-31</a>
            </span>
          </div>
          <!-- /.offer__feedback -->
        </div>
    ...
    <div class="container">
      ...
      <div class="cards">
        ...
        <div class="card price__card wow fadeInUp" data-wow-delay="0.1s">
          <div class="card__image"><img src="img/price/bathroom.jpg" alt="Выполненный нами ремонт ванной комнаты и с/у"></div>
          <!-- /.card__image -->
        ...
        <div class="card price__card wow fadeInUp" data-wow-delay="0.2s">
          <div class="card__image"><img src="img/price/living.jpg" alt="Выполненный нами ремонт квартиры"></div>
          <!-- /.card__image -->
          <div class="card__text">
        ...
        <div class="card price__card wow fadeInUp" data-wow-delay="0.3s">
          <div class="card__image"><img src="img/price/office.jpg" alt="Выполненный нами ремонт офиса"></div>
          <!-- /.card__image -->
          <div class="card__text">
        ...
        <div class="card price__card wow fadeInUp" data-wow-delay="0.4s">
          <div class="card__image"><img src="img/price/bildings.jpg" alt="Выполненный нами ремонт новостройки"></div>
          <!-- /.card__image -->
          <div class="card__text">
        ...
        <div class="card price__card wow fadeInUp" data-wow-delay="0.5s">
          <div class="card__image"><img src="img/price/kitchen.jpg" alt="Выполненный нами ремонт кухни"></div>
          <!-- /.card__image -->
          <div class="card__text">
        ...
        <div class="card price__card wow fadeInUp">
          <div class="card__image"><img src="img/price/hauses.jpg" alt="Выполненный коттеджа"></div>
          <!-- /.card__image -->
          <div class="card__text">
  ...
  <div class="section proffer">
    <div class="proffer__title-block">
      <div class="contaner">
        <h2 class="proffer__title increase-animated">Ремонт обойдется Вам дешевле, так как<br>мы используем качественные материалы по оптовым ценам</h2>
      </div>
    </div>
    <div class="container">
    <div class="proffer-wrapper">
      
      <div class="proffer__item wow fadeInUp" data-wow-delay="0.1s">
      ...
      <div class="proffer__item wow fadeInUp" data-wow-delay="0.2s">
        <div class="proffer__image">
      ...
      <div class="proffer__item wow fadeInUp" data-wow-delay="0.3s">
        <div class="proffer__image">
  ...
  <div class="section guarantee">
    <div class="container">
      <h2 class="guarantee__title increase-animated">Все наши гарантийные обязательства подробно и прозрачно описаны в договоре</h2>

      <div class="guarantee-wrapper">

        <div class="guarantee__item wow fadeInUp" data-wow-delay="0.1s">
          <div class="guarantee__image">
          <img src="img/guarantee/guarantee-2.jpg" class="guarantee__scan" alt="Скан документа гарантии стр. 1">
          </div>
  ...
  <section class="section brif">
    <div class="container">
      <div class="brif-block">
        <div class="interview brif__interview wow fadeInRight" data-wow-delay="0.2s">
        ...
        <div class="brif__form wow fadeInLeft" data-wow-delay="0.2s">
  ...
  <!-- /.modal -->  
   <div class="message" id="message">
     ...
     <h3 class="message-dialog__tilte">123</h3>
     </div>
   </div>
   <!-- /.message -->
  ...
  <div class="footer">
    ...
    <!-- /.map -->
    <div class="container">
      <div class="contacts-block wow fadeInRight" data-wow-delay="0.2s">
        <div class="contacts">
